...
// func TestInit(t *testing.T) {
// 	type testCase struct {
// 		givenOSEnvF     func(t *testing.T) func()
// 		givenNewSentryF func(Config) (*sentry.Hub, error)
// 		givenNewNRF     func(Config) (*newrelic.Application, error)
// 		expErr          error
// 		expCfg          Config
// 		expSentry       bool
// 		expNR           bool
...
// 		t.Run(name, func(t *testing.T) {
// 			// Given:
// 			osEnvCleanup := tc.givenOSEnvF(t)
// 			defer osEnvCleanup()
// 			defer func() {
// 				newSentryF = newSentry
// 				newNewRelicF = newNewRelic
// 			}()
// 			newSentryF = tc.givenNewSentryF
// 			newNewRelicF = tc.givenNewNRF
//
// 			// When:
// 			ctx, finish, err := Init()
//
...
// 				require.EqualValues(t, tc.expCfg, cfg)
//
// 				require.NotNil(t, zapFromContext(ctx))
// 				require.NotNil(t, otelTracerFromContext(ctx))
//
// 				require.Equal(t, tc.expSentry, sentry.GetHubFromContext(ctx) != nil)
// 				require.Equal(t, tc.expNR, newRelicFromContext(ctx) != nil)
//
// 				finish()
// 			}
// 		})
